...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './collection-category.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COLLECTIONCATEGORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_COLLECTIONCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COLLECTIONCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COLLECTIONCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COLLECTIONCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COLLECTIONCATEGORY actions', async () => {
      const expectedActions = [
        {
